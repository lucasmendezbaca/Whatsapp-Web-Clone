        ...
        <div className="Intro-Left" id="Intro-Left">
            <div className="intro">
                <div className="intro-svg">
                    <span className="IVxyB">
                        <svg width="360" viewBox="0 0 303 172" fill="none" className="">
                            ...
                            <path fillRule="evenodd" clipRule="evenodd"
                                ...
                                fill="var(--intro-svg2)" fillOpacity="var(--intro-opacity)">
                            </path>
                ...
                <div className="intro-sub">
                    <h1 className="intro-text">Whatsapp Web Clone</h1>
                    <span className="intro-span">Send and receive messages without keeping your phone online.
                        <br />
